...
const VenmoIcon = ({ className }: { className?: string }) => (
  <svg 
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M19.5 3c.9 1.5 1.3 3 1.3 4.9 0 6.1-5.2 14-9.4 19.6H3.5L.5 3.5l7.5-.7 1.7 13.8c1.6-2.6 3.6-6.7 3.6-9.5 0-1.8-.3-3-0.8-4l7-.1z"/>
  </svg>
);
          ...
          <CardContent className="space-y-6 px-6 pb-8">
            ...
            <div className="space-y-2">
              <Label htmlFor="venmoId" className="flex items-center gap-2 text-sm font-medium">
                <VenmoIcon className="h-4 w-4 text-[#008CFF]" />
                Venmo Username
              </Label>
              <Input
                id="venmoId"
